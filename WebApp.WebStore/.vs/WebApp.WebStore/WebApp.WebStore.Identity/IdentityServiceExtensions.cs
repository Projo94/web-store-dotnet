...
using WebApp.WebStore.Identity.Services;
...
namespace WebApp.WebStore.Identity
{
    public static class IdentityServiceExtensions
    {
        public static IServiceCollection AddIdentityServices(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            services.AddDbContext<WebStoreIdentityDbContext>(options => options.UseSqlServer(configuration.GetConnectionString("WebStoreIdentityConnectionString"),
